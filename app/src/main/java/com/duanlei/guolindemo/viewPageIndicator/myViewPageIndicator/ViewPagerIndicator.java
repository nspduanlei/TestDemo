...
public class ViewPagerIndicator extends LinearLayout {
    ...
    //文字颜色
    private final static int COLOR_TEXT_NORMAL= 0x77ffffff;
    //选中颜色
    private final static int COLOR_TEXT_HIGHLIGHT= 0xffffffff;
    ...
    public ViewPagerIndicator(Context context, AttributeSet attrs) {
        ...
        mTabVisibleCount = a.getInt(
                R.styleable.ViewPagerIndicator_visible_tab_count_my,
                COUNT_DEFAULT_TAB);
    ...
    public void scroll(int position, float positionOffset) {
        ...
        if (position >= mTabVisibleCount - 2 && positionOffset > 0 &&
            ...
            if (mTabVisibleCount != 1) {
                this.scrollTo(
                        (position - (mTabVisibleCount - 2)) * tabWidth
    ...
    public interface PageOnPageChangeListener {
        void onPageScrolled(int position, float positionOffset, int positionOffsetPixels);
        void onPageSelected(int position);
        void onPageScrollStateChanged(int state);
    }
    public PageOnPageChangeListener mListener;

    public void setOnPageChangeListener(PageOnPageChangeListener listener) {
        mListener = listener;
    }
     ...
     * @param pos
     */
    public void setViewPager(ViewPager viewPager, final int pos, List<String> titles, int tabCount) {
